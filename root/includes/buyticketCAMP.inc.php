...
if(isset($_POST['buyticketCAMP-submit'])){
    ...
    if(empty($firstname) || empty($lastname) || empty($IBAN)){
        header("Location: ../tickets.php?error=emptyfields&firstname=".$firstname."&lastname=".$lastname."&IBAN=".$IBAN);
        exit();
    }
        ...
        header("Location: ../tickets.php?error=invalidIBAN2&firstname=".$firstname."&lastname=".$lastname);
        exit();
